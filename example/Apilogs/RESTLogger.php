...
namespace App\Apilogs;


use AWT\AbstractLogger;
use AWT\ApiLog;
...
class RESTLogger extends AbstractLogger implements ApiLoggerInterface
{
    protected $logs = [];
    ...
    public function logData($request,$response){
        ...
        $this->logs['response_data'] = $response->getContent();
